...
export function Delegation() {
  ...
  const flareForwardDelegationAddress =
    flareForward?.address.toLowerCase() ??
    rewards?.delegation_address?.toLowerCase() ??
    null;
    ...
    <div className="space-y-6">
      {isConnected && (
        <EarningsStrip
          ...
          earnedTotalWei={earned.data?.earned.delegationWei}
            ...
            <CardContent className="p-5 space-y-6">
              {!isConnected ? (
                <div className="text-center py-8 text-[#8FA0B8] flex flex-col items-center gap-4">
                  ...
                  <p className="text-sm">
                    Connect your wallet to delegate on Flare Mainnet.
                  </p>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="glass-panel p-3">
                          <div className="text-xs text-[#8FA0B8] mb-1">
                            FLR in wallet
                          </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between text-sm">
                          <span className="text-[#8FA0B8]">
                            Wrap or unwrap (optional)
                          </span>
                          <button
                            onClick={() =>
                              setWrapAmount(formatFlrInput(flrBalance))
                            }
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <Button
                            ...
                            disabled={
                              ...
                              Number(wrapAmount) <= 0 ||
                              Number(wrapAmount) >
                                Number(formatUnits(flrBalance, 18))
                            }
                            onClick={handleWrap}
                          >
                            {busy === "wrap" ? (
                          ...
                          <Button
                            ...
                            disabled={
                              ...
                              Number(wrapAmount) <= 0 ||
                              Number(wrapAmount) >
                                Number(formatUnits(wflrBalance, 18))
                            }
                        ...
                        <>
                          ...
                          <div className="bg-[#EE1A58]/10 border border-[#EE1A58]/20 rounded-lg p-3 flex gap-3 text-sm">
                            ...
                            <div className="text-[#FAFAFA]">
                              Your delegation is a standing instruction, not a
                              balance — 100% of your vote power, set once. Any
                              FLR you wrap from here follows it automatically,
                              with nothing further to sign. Your tokens never
                              leave your wallet.
                            </div>
                          </div>
                        </>
                        ...
                        <>
                          <div className="bg-[#EE1A58]/10 border border-[#EE1A58]/20 rounded-lg p-3 flex gap-3 text-sm">
                            ...
                            <div className="text-[#FAFAFA]">
                              ...
                              vote power to FlareForward. Your tokens never
                              leave your wallet.
                            </div>
                          </div>
                          ...
                          {!confirming ? (
                            <Button
                              ...
                              className="w-full"
                              disabled={
                                busy !== null || !hasVotePower || !flareForward
                              }
